...
function AuthForm() {
  ...
  return <section className="auth-card"><div className="auth-intro"><h1>{mode === "login" ? "Welcome back" : "Create your account"}</h1><p>{mode === "login" ? "Sign in to your dedicated PaanDukaan account." : "Order as a customer or publish real inventory as a seller."}</p></div>
