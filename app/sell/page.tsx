...
export default function SellPage() {
  ...
  if (!user) return <div className="page container"><section className="seller-invite"><div><span className="eyebrow">SELL ON MERAPAAN</span><h1>Your paan shop,<br/>now easier to discover.</h1><p>Publish real inventory, accept scheduled pickup orders, and receive payment directly from customers.</p><Link className="button button-gold" href="/login?next=/sell">Create seller account <Icon name="arrow"/></Link></div><span><Icon name="shop"/></span></section></div>;
